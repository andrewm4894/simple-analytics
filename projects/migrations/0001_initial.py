...
class Migration(migrations.Migration):
    ...
    operations = [
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "time_window",
                                "Time window sampling (sample within time periods)",
                            ),
                        ],
                        default="random",
        ...
        migrations.AddIndex(
            model_name="project",
            index=models.Index(
                fields=["owner", "created_at"], name="projects_owner_i_eab97e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="project",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["project", "is_active"], name="event_sourc_project_f08060_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="eventsource",
            index=models.Index(
                fields=["project", "name"], name="event_sourc_project_34cd2a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="eventsource",
            index=models.Index(
                fields=["last_event_at"], name="event_sourc_last_ev_f625be_idx"
            ),
        ),
